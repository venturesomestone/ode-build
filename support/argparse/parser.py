...
"""
Extensions to the standard argparse ArgumentParer class to
support multiple destination actions as well as a new builder DSL
for declaratively constructing complex parsers.
"""
...
class _ActionContainer(object):
    """
    A container object holding partially applied actions used as
    a part of the builder DSL.
    """
...
class _CompoundAction(Action):
    """
    An Action composed of multiple actions. Default attributes
    are derived from the first action.
    """
...
class _PartialAction(Action):
    """
    An Action that is partially applied, creating a factory
    closure used to defer initialization of acitons in the
    builder DSL.
    """
...
class _Builder(object):
    """
    A builder object for constructing complex ArgumentParser
    instances with a more friendly and descriptive DSL.
    """
...
class ArgumentParser(argparse.ArgumentParser):
    """
    A thin extension class to the standard ArgumentParser which
    incluldes methods to interact with a builder instance.
    """
    ...
    def parse_known_args(self, args=None, namespace=None):
        """
        Thin wrapper around parse_known_args that shims in
        support for actions with multiple destinations.
        """
