...
def _script_path():
    # Get the parent directory of this file for checking if this file is in an
    # Unsung Anthem checkout.
    #
    # $ANTHEM_SOURCE_ROOT/build/script/support/variables.py
    script_path = os.path.dirname(os.path.dirname(__file__))

    # Split the path as the first part of the 'script_path' is likely the
    # 'script' folder.
...
# $ANTHEM_SOURCE_ROOT is got from the path of this file if the environment
# variable is not set.
