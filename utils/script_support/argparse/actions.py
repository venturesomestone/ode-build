...
__all__ = [
    ...
    "AppendAction", "CustomCallAction", "StoreAction", "StoreIntAction",
    "StoreTrueAction", "StoreFalseAction", "StorePathAction",
    "ToggleTrueAction", "ToggleFalseAction", "UnsupportedAction"
]
...
class Nargs(object):
    """
    Container class holding valid values for the number of arguments actions
    can accept. Other possible values include integer literals.
    """
