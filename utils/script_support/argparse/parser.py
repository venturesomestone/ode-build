...
class _PartialAction(Action):
    """
    Action that is partially applied, creating a factory closure used to defer
    initialization of acitons in the builder DSL.
    """
...
class _Builder(object):
    """
    Builder object for constructing complex ArgumentParser instances with a
    more friendly and descriptive DSL.
    """
